...
public class Library {
	...
	public void createLibraryWithSingleBook(@Named("isbn") String isbn,
			@Named("title") String title, @Named("edition") String edition)
			throws SQLException {
		emptyLibrary();
		database.execute("INSERT INTO Book(id,title,author,edition,isbn,year) VALUES "
				+ "(0,"
	...
	public void thenTheDatabaseContainsNoEntryForBookisbnTitleEdition(
			@Named("isbn") String isbn, @Named("title") String title,
			@Named("edition") String edition) throws SQLException {
		database.shouldReturnNothing("SELECT * FROM Book WHERE isbn = '" + isbn
